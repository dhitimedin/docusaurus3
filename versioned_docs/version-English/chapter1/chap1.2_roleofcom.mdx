...
#### Figure 1: Foundational design principles for MCOMS.


<table>
    <tr>
        <Tabheader color="#FFE5CC ">
            <ol>
                <li>Accurate and comprehensive record keeping</li>
            </ol>
        </Tabheader>
        <Tabheader color="#FFE5CC">
            <ol>
                <li>Real-time communication, control, and updates</li>
            </ol>
        </Tabheader>
    </tr>
    <tr>
        <Tabcell color="#FFB266">
            <ul>
