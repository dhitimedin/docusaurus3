...
The field agent app is fully documented in [Chapter 3](../chapter3/Field_Agent_App).
...
The MCOMS components discussed in the preceding [Section 1.3.1](./MCOMS_Interfaces_and_System_Integration#131-front-end-interfaces) all exchange commands and information in real time. To fully appreciate and leverage the potential of MCOMS, it is necessary to get a basic overview of the various information pipelines, and how distributed hardware and software talk to each other.
...
#### Figure 9: Technical monitoring of mini-grid supply-side equipment.