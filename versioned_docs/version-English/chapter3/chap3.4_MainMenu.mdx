...
1. <u>Total Billing</u> is explained in Section 3.4.3.1
2. <u>Total Collection</u> is explained in Section 3.4.3.2
...
6.  <u>Tap</u> any entry to view customer's account page (Section 3.5.2)
