...
<table>
    ...
    <tr>
        <Tabcell color="#AED6F1">Information on package request</Tabcell>
        <Tabcell color="#AED6F1">Lists requests that are being worked on</Tabcell>
        <Tabcell color="#AED6F1">Completed requests that are awaiting approval</Tabcell>
        <Tabcell color="#AED6F1">Details of historical package requests</Tabcell>
    </tr>
</table>
