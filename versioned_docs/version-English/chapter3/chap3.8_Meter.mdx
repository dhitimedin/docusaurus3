...
<table>
    ...
    <tr>
        <Tabcell color="#AED6F1">View of pending meter requests, assign to agent, and mark completed</Tabcell>
        <Tabcell color="#AED6F1">List of completed meter requests</Tabcell>
        <Tabcell color="#AED6F1">List of historical completed and acknowledged meter requests</Tabcell>
    </tr>
</table>
...
* Refer to [Section 3.4.5](./Main_Menu#345-spark-server) for more information
